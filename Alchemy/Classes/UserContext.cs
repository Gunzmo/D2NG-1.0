...
namespace Alchemy.Classes
{
    ...
    public class UserContext
    {
        ...
        /// </summary>
        public DataFrame DataFrame { get { if (_dataFrame == null) return null; lock (_dataFrame) { return _dataFrame; } } set { if (_dataFrame != null) { lock (_dataFrame) { _dataFrame = value; } } else { _dataFrame = value; } } }
